...
describe('set order status as transfer finished (e2e)', () => {
	...
	test('[PATCH] /orders/:orderId/set-status/transfer-finished', async () => {
		...
		const response = await request(app.getHttpServer())
			.patch(`/orders/${orderId}/set-status/transfer-finished`)
